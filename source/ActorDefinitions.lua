...
----- Image Loading -----
goblinImg = gfx.image.new("images/ACTORS/GOBLIN")
batImg = gfx.image.new("images/ACTORS/BAT")
frogImg = gfx.image.new("images/ACTORS/FROG")
warlockImg = gfx.image.new("images/ACTORS/WARLOCK")
